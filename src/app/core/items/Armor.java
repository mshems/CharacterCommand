...
import app.core.character.Attribute;
            ...
            switch (armorType){
                case L_ARMOR:
                    if(!c.isArmored()){
                        ...
                        //CharacterCommand.terminal.println(this.getName()+" equipped");
                    } else {
                        //CharacterCommand.terminal.println("ERROR: Already wearing armor");
                    }
                    break;
                case M_ARMOR:
                    if(!c.isArmored()){
