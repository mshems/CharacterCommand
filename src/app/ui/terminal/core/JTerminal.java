...
import app.ui.terminal.core.event.*;
import app.ui.terminal.core.theme.*;
import app.ui.terminal.core.util.Strings;
...
public class JTerminal implements JTerminalEventListener, ThemedComponent {
    ...
    /**
     * Returns the next input token in the token buffer as an <code>int</code>.
    ...
    /**
     * Returns the next input token in the token buffer as a <code>double</code>.
    ...
    /**
     * Returns the next input token in the token buffer as a <code>boolean</code>.
